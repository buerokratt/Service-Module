    ...
    return (
        <Track direction="vertical" align="stretch">
                            ...
                            isObject(variable.data) ? (
                                                ...
                                                <OutputElementBox
                                                    ...
                                                    onClick={() => {
                                                        setAssignedObjectTree(
                                                            assignedObjectTree?.path === variable.value ? null : {
                                                                data: variable.data,
                                                                path: variable.value
                                                            }
                                                        );
                                ...
                                <>
                                    {(() => {
                                        ...
                                        return (
                                            <Tooltip content={`${variable.value} : ${typeColor.type}`}>
                                                <OutputElementBox style={{border: `2px outset ${typeColor.color}`}}
                                                                  text={variable.key} value={variable.value}
                                                                  useValue/>
                                            </Tooltip>
                                        )
                                            ;
            ...
            {endpoints.map((endpoint) => (
                <Track key={endpoint.name} direction="vertical" align="left"
                                                ...
                                                <OutputElementBox
                                                    ...
                                                    onClick={() => {
                                                        setEndpointsObjectTree(
                                                            endpointsObjectTree?.path === chip.value ? null : {
                                                                data: chip.data,
                                                                path: chip.value
                                                            }
                                                        );
