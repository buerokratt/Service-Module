...
- Using pre defined config secrets depends on this [Datamapper PR](https://github.com/buerokratt/DataMapper/pull/11)
- Testing the service flow using .tmp files depends on this [Ruuter PR](https://github.com/buerokratt/Ruuter/pull/153). Secrets under `secrets/` directory are mock data which can be replaced using volumes in docker compose
